...
type LoginResponse struct {
	...
	Token int64 `protobuf:"varint,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the logged user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x12, 0x66, 0x61, 0x72, 0x69, 0x64, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
